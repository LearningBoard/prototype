define(['../ActivityFormTemplate'], function(ActivityFormTemplate){
  ...
  var QuizFormTemplate = function() {
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="${this.type}_link" name="${this.type}_link" placeholder="Quiz link (support Qzzr)" pattern=".*(qzzr.com|classmarker.com).*" required>
    </div>`;
